...
public class GeneralConfig extends BaseMekanismConfig {
    ...
    public final CachedBooleanValue digitalStorageUnitEnabled;
    ...
    GeneralConfig() {
...

        {
            ...
            this.digitalStorageUnitEnabled = CachedBooleanValue.wrap(this, builder.comment("Whether to allow use of the Digital Storage Unit").define("digitalStorageUnitEnabled", true));
            builder.pop();
